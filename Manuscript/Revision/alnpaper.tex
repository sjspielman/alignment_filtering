...
\hline\noalign{\smallskip}
& & & \multicolumn{4}{c}{Mean True Positive Rate} & \multicolumn{4}{c}{Mean False Positive Rate} \\
\cline{4-7}\noalign{\smallskip}\cline{8-11}\noalign{\smallskip} 
\multicolumn{1}{p{1.5cm}}{\centering Selective \\ Profile} & \multicolumn{1}{p{1.5cm}}{\centering Number \\ of Taxa} & \multicolumn{1}{p{1.5cm}}{\centering Inference \\ Method} & \multicolumn{1}{c}{True} & \multicolumn{1}{c}{Unfiltered} & \multicolumn{1}{c}{Guidance} & \multicolumn{1}{c}{GuidanceP} & \multicolumn{1}{c}{True} & \multicolumn{1}{c}{Unfiltered} & \multicolumn{1}{c}{Guidance} & \multicolumn{1}{c}{GuidanceP} \\
...
& & PAML &  0.422 & 0.347 & 0.342 (-1.68\%) & 0.337 (-2.92\%) &  $1 \times 10^{-4}$ &  $2.80 \times 10^{-3}$ & \textbf{$2.1 \times 10^{-3}$ (-26.1\%)$^{\ast\ast\ast}$} &  \textbf{$1.6 \times 10^{-3}$ (-43.7\%)$^{\ast\ast\ast}$} \\
 & 158 & FUBAR & 0.515 & 0.458 & \textbf{0.467 (1.88\%)$^{\ast\ast}$} & \textbf{0.468 (2.12\%)$^{\ast\ast}$} &  $1.60 \times 10^{-3}$ &  $5.60 \times 10^{-3}$ & \textbf{ $3.5 \times 10^{-3}$ (-37.7\%)$^{\ast\ast\ast}$} &  \textbf{$1.5 \times 10^{-3}$ (-73.3\%)$^{\ast\ast\ast}$} \\
\noalign{\smallskip}\hline\noalign{\smallskip}
GP41 & 11 & FUBAR & 0.062 & 0.058 & 0.057 (-1.55\%) & 0.057 (-1.21\%) &  $6 \times 10^{-4}$ &  $1.20 \times 10^{-3}$ &  $9 \times 10^{-4}$ (-25.36\%)$^{\ast\ast\ast}$ &  \textbf{$9 \times 10^{-4}$ (-25.36\%)$^{\ast\ast\ast}$} \\
& & PAML & 0.096 & 0.098 & \textbf{0.095 (-3.49\%)$^{\ast\ast\ast}$} & 0.095 (-3.8\%)$^{\ast\ast\ast}$ &  $1.8 \times 10^{-3}$ &  $3.3 \times 10^{-3}$ & \textbf{$2.6 \times 10^{-3}$ (-22.3\%)$^{\ast\ast\ast}$} &  \textbf{$2.6 \times 10^{-3}$ (-22.3\%)$^{\ast\ast\ast}$} \\
& 26& FUBAR & 0.215 & 0.196 & \textbf{0.200 (1.89\%)$^{\ast\ast}$} & 0.197 (0.36\%) &  $2.1 \times 10^{-3}$ &  $4.5 \times 10^{-3}$ & \textbf{0.004 (-11.4\%)$^{\ast}} $ &  \textbf{$3.5 \times 10^{-3}$ (-22.5\%)$^{\ast\ast\ast}$} \\
& & PAML & 0.237 & 0.216 & 0.220 (1.53\%) & 0.217 (0.24\%) &  $1.6 \times 10^{-3}$ &  $4.3 \times 10^{-3}$ & 0.004 (-6.6\%) &  \textbf{$3.6 \times 10^{-3}$ (-15.9\%)$^{\ast\ast}$} \\
& 60& FUBAR & 0.359 & 0.308 & \textbf{0.313 (1.77\%)$^{\ast\ast}$} & 0.304 (-1.16\%) &  $2.5 \times 10^{-3}$ & 0.0109 & \textbf{$9.7 \times 10^{-3}$ (-11.1\%)$^{\ast\ast\ast}$} &  $7.9 \times 10^{-3}$ (-27.6\%)$^{\ast\ast\ast}$ \\
& & PAML & 0.341 & 0.304 & 0.302 (-0.77\%) & \textbf{0.296 (-2.71\%)$^{\ast\ast}$} &  $8 \times 10^{-4}$ &  $9.3 \times 10^{-3}$ & \textbf{$7.9 \times 10^{-3}$ (-14.86\%)$^{\ast\ast\ast}$} &  \textbf{$6.4 \times 10^{-3}$ (-31.0\%)$^{\ast\ast\ast}$} \\
& 158 & FUBAR & 0.344 & 0.320 & \textbf{0.325 (1.77\%)$^{\ast\ast\ast}$} & \textbf{0.326 (2.02\%)$^{\ast\ast\ast}$} &  $3.10 \times 10^{-3}$ &  $7 \times 10^{-3}$ & \textbf{$5.1 \times 10^{-3}$ (-27.5\%)$^{\ast\ast\ast}$} &  \textbf{$3.5 \times 10^{-3}$ (-50.2\%)$^{\ast\ast\ast}$} \\
\noalign{\smallskip}\hline\noalign{\smallskip}
\end{tabular}
\newline
